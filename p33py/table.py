def table(metric):
    ...
    prop_target = metric_clean[
        (metric_clean["var_ethnic"] == "white")
        | (metric_clean["var_ethnic"] == "asian")
    ]["metric_value"].mean()
    ...
    metric_display = metric_clean[
        ["var_ethnic", "population", "subset_popul", "popul_target", "gap"]
    ]
