...
<svelte:head>
	...
	<meta
		content="Combining numerous data sources to assess how well schools, colleges and companies support underrepresented populations on tech career pathways in Chicago."
		name="description"
	/>
</svelte:head>
...
<div class="block p-4 lg:p-10 bg-white">
	<p class="bg-really-light-gray my-8 pl-6 pr-2 py-4 font-mono">
		...
		intend to add additional metrics, comparisons with individual cities, and data to show progress
		over time.
	</p>
	<p>
		All data is based on a Index of Disparity constructed in a research paper (<a
			class="text-brand-primary-green"
			href="https://open.umich.edu/sites/default/files/downloads/PublicHealthRep-Pearcy.pdf"
			target="_blank">Percy Keppel 2002</a
		>) and adopted by Policy Link’s
		<a
			class="text-brand-primary-green"
			href="https://nationalequityatlas.org/about-the-atlas/methodology/indexmethod"
			target="_blank">National Equity Index</a
		>.
	</p>
	<p>
		This equation is relatively simple, performs well at diagnosing inequity, and offers an unbiased
		approach when assessing different race/ethnic groups and population sizes.
	</p>
	<p>
	...
	<p>
		After applying the Index of Disparity equation to each metric, we take the square root of each
		metric score to limit the effect of outliers on the data.
	</p>
	<p>
		We scale the numbers from 0-100 where 0 represents the largest example of disparity between
		race/ethnic groups and 100 represents no disparity between race/ethnic groups. The 0-100 scale
		is used to make the data presentation more intuitive for the audience.
	</p>
	<p>
		Now that each metric score is calculated and scaled properly, we find the framework score
		(Proficiency, Excellence, Access) by taking the geometric mean of each metric in each framework.
	</p>
	<p>
		Lastly, we find the life stage score (K-8, HS, College, Career) by taking the geometric mean of
	...
	<div class="bg-really-light-gray mt-10">
		...
		<div class="p-6">
			<p>
				...
				Latino students to pursue and succeed on Computer Science pathways?
			</p>
			<p>
				<span class="text-brand-primary-green">Access:</span> How much access do Black and Latino communities
				have to the resources and opportunities necessary to succeed on Computer Science pathways?
			</p>
			<p>
				<span class="text-brand-primary-green">Excellence:</span> How well are we preparing Black and
				Latino students to succeed at elite levels on Computer Science pathways?
			</p>
		</div>
	</div>
</div>
