...
<CardPage>
    ...
    <div class="col-span-1 md:col-span-4">
        <p class="bg-really-light-gray my-8 pl-6 pr-2 py-4 font-mono">
            The Equity Index scores are based on more than 20 individual metrics secured primarily from government and other official sources,
            using the latest available data for each metric. We intend to add additional metrics, comparisons with individual cities, and data to show progress over time.
        </p>
        <p>All data is based on a Index of Disparity constructed in a research paper
            (<a target="_blank"
                href="https://open.umich.edu/sites/default/files/downloads/PublicHealthRep-Pearcy.pdf"
                class="text-brand-primary-green">Percy Keppel 2002</a>) and adopted by Policy Link’s
            <a target="_blank"
                href="https://nationalequityatlas.org/about-the-atlas/methodology/indexmethod"
                class="text-brand-primary-green">National Equity Index</a>.</p>
        ...
        <div class="bg-really-light-gray mt-10">
            ...
            <p class="py-2 text-center font-sans-alternate"> <MathEquation math={`Index~of~disparity = \\frac{\\sum{[|r_i - R|]}}{R * N}`} /> </p>
            <p class="py-2 text-center font-sans-alternate"> <MathEquation math={`Geometric Mean = \\sqrt[N]{x_1 * x_2 * ... * x_N}`} /> </p>
            <p class="py-6 text-center font-sans-alternate"> <MathEquation math={`Scaling Equation = 100 - \\frac{Index~of~Disparity_i - Min(Index~of~Disparity)}{Max(Index~of~Disparity)}`} /> </p>
            <hr class="border-1 border-light-gray mx-4"/>
            <div class="p-6">
                <p><span class="text-brand-primary-green">Proficiency:</span> How well are we preparing Black and Latino students to pursue and succeed on Computer Science pathways?</p>
                <p><span class="text-brand-primary-green">Access:</span> How much access do Black and Latino communities have to the resources and opportunities necessary to succeed on Computer Science pathways?</p>
                <p><span class="text-brand-primary-green">Excellence:</span> How well are we preparing Black and Latino students to succeed at elite levels on Computer Science pathways?</p>
            </div>
        </div>
    </div>
</CardPage>