...
<div class="w-full bg-white py-6">
	<BodyContentContainer>
		...
		<BlockQuote class="col-span-4 text-lg lg:text-2xl">
			Skilled tech jobs are fast-growing and high-paying. They lift individuals and grow our economy. 
			But companies struggle to fill these roles while Black and Latino Chicagoand and women have largely 
			been kept on the sidelines. Chicago has an opportunity: <TextHighlight>Reduce race-based inequality and
			accelerate economic growth</TextHighlight> by diversifying the tech workforce. 
			<p></p>
			<p>
			This is Chicagoland's first effort to understand the full picture of what it will take to make Chicago
			the most inclusive tech city in the country. This isn't just a company issue or a pipeline problem: there
			is critical work to do from grammar school to the C-suite.
				<TextHighlight>Now, let’s make it happen!</TextHighlight> </p>
		</BlockQuote>
	</BodyContentContainer>
</div>
<div class="w-full py-4 bg-white">
	<BodyContentContainer>
		<div>
			<Callout heading="Why Tech Matters">
				<img
					alt=""
		...
		<div>
			<Callout heading="What is Success">
				<img
					alt=""
					class="object-scale-down h-8 w-8"
					slot="image"
...
<MapBackground>
	<BodyContentContainer>
		<div class="col-span-1 sm:col-span-4 text-white pt-4">
			...
			<p class="font-mono">
				The Equity Index score of 0 – 100 measures the gap between how we are serving different
				racial and ethnic populations on tech career pathways. An Equity Index score of 100 would
				indicate that we are providing equal access to all groups and serving them equally well.
				Scores further from 100 indicate our “distance from equity,” with Black and Latino
				populations receiving less access to opportunity and experiencing worse outcomes. Think of
				any score below 90 as a major concern.
			</p>
		</div>
		<Scorecard {scorecard} />
