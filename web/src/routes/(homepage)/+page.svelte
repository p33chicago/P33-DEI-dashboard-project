...
<BodyContentContainer>
	<!-- top part -->
	<BlockQuote class="col-span-4 text-lg lg:text-2xl mt-16 sm:-mt-[1.9rem]">
		<p>
			...
			been kept on the sidelines. Chicago has an opportunity: <TextHighlight>
...
<MapBackground>
	<BodyContentContainer>
		...
		<Scorecard {scorecard} />
		<div
			class="text-white col-span-1 sm:col-span-4 bg-black/60 px-8 py-4 bg-blend-multiply lg:mt-6 mb-6 pb-4 rounded-lg"
		>
			<Definitions />
		</div>
	</BodyContentContainer>
