...
>
	<svelte:fragment slot="story">
		<p>
			At the University in Illinois, the number of students who obtain a diploma in CS is less than
			1/3 of the total enrollment in the CS program.
		</p>
		<p>
			The number of Hispanic and Black students who obtain a diploma in CS is around 1/5 of the
	...
	<svelte:fragment slot="takeaways">
		<p>
			Around 1 out of 5 Black and Hispanic students at the universities of Illinois who enrolled in
...
>
	<svelte:fragment slot="story">
		<p>
			At the Universities in Illinois, Over 13 out of 100 Asian graduates are CS majors, the ratio
			is 3 out of 100 for other ethnic groups.
		</p>
	</svelte:fragment>

	<svelte:fragment slot="takeaways">
		<p>
			At the Universities in Illinois, the percentage of Hispanic and Black students who obtained a
