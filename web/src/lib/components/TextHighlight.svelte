...
<span
	...
	style:border-top-width={rem(offset_top)}
	style:margin-bottom={rem(-offset_bottom)}
	style:margin-left={rem(-offset_left)}
	style:margin-right={rem(-offset_right)}
	style:margin-top={rem(-offset_top)}
>
	<slot />
</span>
